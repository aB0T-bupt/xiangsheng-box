...
export default defineConfig({
  css: {
    preprocessorOptions: {
      scss: {
        api: 'modern-compiler',
        // UniApp's Vue SFC adapters still enter Sass through the legacy API on
        // H5 and mp-weixin. Keep this upstream-only deprecation scoped until a
        // verified stable compiler release removes those calls.
