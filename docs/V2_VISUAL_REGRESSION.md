...
本清单对应 [#346](https://github.com/e-dialect/xiangsheng-box/issues/346)，用于在 V2 界面分支聚合后进行可重复的人工视觉巡检。当前 `frontend/src/pages.json` 注册 **39 个页面**；测试固定使用 390×844 视口，生成 **66 张截图**：39 个注册路由、4 个核心界面的 16 种主题/身份组合、“听”页的 4 种数据状态，以及 7 个主题次级旅程。
